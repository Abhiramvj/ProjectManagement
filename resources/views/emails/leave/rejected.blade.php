@component('mail::message')
    # Leave Application Rejected Hello {{ $leaveApplication->user->name }}, We
    have reviewed your recent leave application. Unfortunately, we are unable to
    approve your request at this time. ## Application Details - **Employee:**
    ...
    - **Duration:** {{ $leaveApplication->leave_days }} day(s) - **Reason for
    Request:** {{ $leaveApplication->reason }} ## Reason for Rejection

    {{--
        This is the key change. We now use the $rejectionReason variable passed
        directly from our Mailable class.
    --}}
    **{{ $rejection_reason ?? 'No specific reason was provided.' }}** If you
