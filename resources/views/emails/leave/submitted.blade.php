@component('mail::message')
    # New Leave Application Submitted Hello, A new leave application has been
    submitted and is awaiting your review. ## Application Details -
    **Employee:** {{ $leaveApplication->user->name }} - **Leave Type:**
    ...
    - **Reason:** {{ $leaveApplication->reason }} **Leave Period:**
    {{ \Carbon\Carbon::parse($leaveApplication->start_date)->format('M d, Y') }}
    to
    {{ \Carbon\Carbon::parse($leaveApplication->end_date)->format('M d, Y') }}
