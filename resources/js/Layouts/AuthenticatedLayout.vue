...
const ApplicationLogo = defineAsyncComponent(
    () => import('@/Components/ApplicationLogo.vue'),
);
const Dropdown = defineAsyncComponent(
    () => import('@/Components/Dropdown.vue'),
);
const DropdownLink = defineAsyncComponent(
...
const navigationItems = computed(() => {
    ...
    const items = [
        ...
        },
        {
            ...
            show:
                user.value.permissions.includes('assign projects') ||
                user.value.permissions.includes('view all projects progress'),
            icon: 'Projects',
        },
        {
        ...
        },
        {
            ...
            active: route().current('leave.fullRequests'),
            show: true,
            icon: 'Your Requests',
        },
        {
        ...
        },
        {
            ...
            active: route().current('leave.manageRequests'),
            show: user.value.permissions.includes('manage leave applications'),
            icon: 'Manage Requests',
        },
        {
            name: 'Leave Audit Logs',
            route: 'leave.logs',
...
const icons = {
    ...
    'MyReviews': `<svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    d="M12 4a4 4 0 110 8 4 4 0 010-8z"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    d="M6 20v-1a6 6 0 1112 0v1"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    d="M17.5 17.5l.87 1.76a.5.5 0 00.91 0l.87-1.76 1.93-.28a.5.5 0 00.28-.85l-1.4-1.37.33-1.92a.5.5 0 00-.72-.53l-1.73.91-1.73-.91a.5.5 0 00-.72.53l.33 1.92-1.4 1.37a.5.5 0 00.28.85l1.93.28z"/>
</svg>`
    ...
    <div>
        ...
        <div class="min-h-screen bg-gray-50 font-sans">
                ...
                >
                    <div class="flex flex-shrink-0 items-center space-x-3 px-4">
                        <Link :href="route('dashboard')">
                            <ApplicationLogo
                                class="block h-8 w-auto text-indigo-600"
                            />
                        </Link>
                    ...
                    <nav
                        ...
                        class="mt-8 flex-1 space-y-2 px-3 pb-4"
                    >
                        <NavLink
            ...
            <div class="flex min-h-screen flex-col md:pl-64">
                <!-- Top bar -->
                <header
                    class="sticky top-0 z-10 flex h-16 flex-shrink-0 items-center justify-between border-b border-gray-200 bg-white px-4 sm:px-6 lg:px-8"
                >
                    <div class="flex items-center">
                        <button
                            @click="showingSidebar = true"
                            type="button"
                            class="border-r border-gray-200 pr-4 text-gray-500 focus:outline-none md:hidden"
                        >
                        ...
                        <div
                            class="pl-4 text-xl font-semibold leading-tight text-gray-800 md:pl-0"
                        >
                            <slot name="header" />
                        </div>
                    </div>
                        ...
                        <template v-if="user">
                            ...
                            <div class="relative">
                                <button
                                    ...
                                    class="relative inline-flex items-center rounded-lg p-2 text-gray-600 transition-colors hover:bg-gray-100 hover:text-gray-900"
                                >
                                    <svg
                                        class="h-6 w-6"
                                        fill="none"
                                ...
                                >
                                    ...
                                    <div class="max-h-64 overflow-y-auto">
                                        ...
                                        <div
                                            ...
                                            "
                                            class="cursor-pointer border-b border-gray-100 p-3 transition-colors hover:bg-gray-50"
                                        >
                                            <div
                            ...
                            <Dropdown align="right" width="48">
                                <template #trigger>
                                    <button
                                        class="flex items-center space-x-3 rounded-lg p-1 transition hover:bg-gray-100"
                                    >
                                        <img
            ...
            >
                ...
                <Transition name="slide-in">
                    <div
                        v-if="showingSidebar"
                        class="fixed inset-y-0 left-0 z-40 flex w-64 flex-col bg-white"
                    >
                        <div
                            class="flex flex-grow flex-col overflow-y-auto border-r border-gray-200 bg-white pt-5"
                        >
                            <div
                                class="flex flex-shrink-0 items-center space-x-3 px-4"
                            >
                                <Link :href="route('dashboard')">
                                    <ApplicationLogo
                                        class="block h-8 w-auto text-indigo-600"
