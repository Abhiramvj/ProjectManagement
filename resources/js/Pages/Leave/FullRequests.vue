        ...
        <div class="mx-auto max-w-7xl p-4 font-sans sm:p-6 lg:p-8">
            ...
            <header class="mb-8">
                ...
                <p class="mt-2 text-slate-600">
                    View and manage your past and upcoming leave applications.
                </p>
            </header>
            ...
            <div class="space-y-4">
                ...
                >
                    <div
                        class="grid grid-cols-1 items-center gap-4 p-5 md:grid-cols-12"
                    >
                        <!-- Date & Type -->
                        <div class="md:col-span-3">
                            <p class="font-bold text-slate-800">
                                ...
                                <span v-if="req.end_date !== req.start_date">
                                    - {{ formatDate(req.end_date) }}</span
                                >
                            </p>
                            <p class="text-sm text-slate-600">
                                {{ formatLeaveDays(req.leave_days) }} day<span
                                    v-if="req.leave_days != 1"
                                    >s</span
                                >,
                        ...
                        <div class="flex items-center gap-2 md:col-span-2">
                            <span
                                :class="`text-${statusInfo(req.status).color}-600`"
                            >
                                <svg
                                    class="h-5 w-5"
                                    fill="none"
                                ...
                                >
                                    <path
                                        ...
                                        stroke-linejoin="round"
                                        stroke-width="2"
                                        :d="statusInfo(req.status).icon"
                                    />
                                </svg>
                            </span>
                            <p
                                :class="`font-semibold text-${statusInfo(req.status).color}-700`"
                            >
                            ...
                            <button
                                ...
                                "
                                @click="
                                    showRejectionReason(req.rejection_reason)
                                "
                        ...
                        >
                            <template v-if="req.status === 'pending'">
                                <button
                                    ...
                                    class="btn-primary-sm text-blue-600"
                                >
                                    Edit
                                </button>
                                <button
        ...
        <teleport to="body">
            ...
            >
                ...
                >
                    ...
                    <div
                        class="max-h-[50vh] overflow-y-auto rounded-lg border border-slate-200 bg-slate-50 p-4"
                    >
                        <p
                            class="whitespace-pre-line break-words text-slate-700"
                        >
                            {{ rejectionReasonToShow }}
                        </p>
                    </div>
                    <div class="mt-6 flex justify-end">
                        <button @click="closeReasonModal" class="btn-secondary">
                            Close
                        </button>
                    </div>
                </div>
