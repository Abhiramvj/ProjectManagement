...
const getDetailsRoute = () => canManageLeaves.value ? route('leave.manageRequests') : route('leave.fullRequests');
</script>
                        ...
                        <nav class="isolate inline-flex -space-x-px rounded-md shadow-sm">
                             <template v-for="(link, index) in paginationLinks" :key="index">
                                <div v-if="link.url === null"
                                     ...
                                     :class="{ 'rounded-l-md': index === 0, 'rounded-r-md': index === paginationLinks.length - 1 }"
                                />
                                <Link v-else
                                      :href="link.url"
                                      v-html="link.label"
