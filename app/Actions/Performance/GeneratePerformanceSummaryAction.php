...
class GeneratePerformanceSummaryAction
{
    ...
    /**
     * Generate AI-powered performance summary for a user.
     */
    public function handle(array $stats, User $user): ?string
    {
        ...
        try {
            ...
            Log::error("Failed to generate performance summary for employee {$user->id}: {$e->getMessage()}");
